...
var SummaryPolygon = function (_Component) {
    ...
    _createClass(SummaryPolygon, [{
        ...
        value: function componentDidMount() {
            ...
            var tempCanvasElm = document.getElementById('temp-' + this.props.canvasId);
            var polygonStyles = this.props.polygonStyles;
        ...
        value: function componentWillReceiveProps(newProps) {
            ...
            var canvasElm = document.getElementById(this.props.canvasId);
            var tempCanvasElm = document.getElementById('temp-' + this.props.canvasId);
            var polygonStyles = newProps.polygonStyles;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('canvas', { id: 'temp-' + canvasId, height: polygonStyles.width, width: polygonStyles.width, style: { display: 'block' } })
            );
        }
    }]);
