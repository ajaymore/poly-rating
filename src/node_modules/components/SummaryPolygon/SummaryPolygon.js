...
export default class SummaryPolygon extends Component {
    ...
    componentDidMount() {
        const canvasElm = document.getElementById(this.props.canvasId);
        const tempCanvasElm = document.getElementById('temp-' + this.props.canvasId);
        const { polygonStyles } = this.props;
    ...
    render() {
        ...
        const { polygonStyles, canvasId } = this.props;
        ...
        return (
            <div className="App" style={{
                ...
                {cornerTitles}
                <canvas id={canvasId} height={polygonStyles.width} width={polygonStyles.width}></canvas>
                <canvas id={'temp-' + canvasId} height={polygonStyles.width} width={polygonStyles.width} style={{ display: 'block' }}></canvas>
            </div>
        );
    }
}